...
# Misc
parser.add_argument('--use_gpu', default=1, type=int) # LEMBRETE
...
def train_model(args): # aka main function
    ...
    if (args.ablation_study):
        ...
        torch.save(global_checkpoint, 'models/global_models_checkpoint_variable_{}.pt'.format(args.dataset_name))
...
def main(dataset, num_epochs, num_epochs_detailed):
    ...
    if args.ablation_study:
        ...
        if args.first_ablation_study:
            ...
            for model in models:
                ...
                # TRANSFORMER model
                    ...
                    #                       blc
                    embedding_dims   = [8 , 16 , 32, 32, 64 , 64]
                    mlp_dim          = [32, 64 , 64, 64, 128, 128]
                    encoder_h_dim_d  = [32, 64 , 64, 64, 128, 128]
                    transformer_blks = [1 , 1  , 2 , 4 , 8  , 16]
        ...
        if args.second_ablation_study:
            ...
            embedding_dims      = [32, 32, 32, 32]
            mlp_dim             = [64, 64, 64, 64]
            encoder_h_dim_d     = [64, 64, 64, 64]
            transformer_blks    = [16, 16, 16, 16] # discover what is the best quantities according to the 1st ablation study
